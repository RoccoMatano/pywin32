...
class PyPrinterHANDLE : public PyHANDLE {
   public:
    ...
    virtual const char *GetTypeName() { return "PyPrinterHANDLE"; }
};
...
void PyWinObject_FreePRINTER_DEFAULTS(PPRINTER_DEFAULTS pdefaults) { PyWinObject_FreeTCHAR(pdefaults->pDatatype); }

// @object PRINTER_DEFAULTS|A dictionary representing a PRINTER_DEFAULTS structure
// @prop string|pDatatype|Data type to be used for print jobs, see <om win32print.EnumPrintProcessorDatatypes>,
// optional, can be None
// @prop <o PyDEVMODE>|pDevMode|A PyDEVMODE that specifies default printer parameters, optional, can be None
// @prop int|DesiredAccess|An ACCESS_MASK specifying what level of access is needed, eg PRINTER_ACCESS_ADMINISTER,
// PRINTER_ACCESS_USE
...
static PyObject *PyClosePrinter(PyObject *self, PyObject *args)
{
    ...
    /* If the object is a PyPrinterHANDLE, its Close method must be called to ensure that the m_handle member is
       cleared. A second handle with the same value can be created as soon as the first handle is closed here, and if
...
static PyObject *PyWinObject_FromPRINTER_INFO(LPBYTE printer_info, DWORD level)
{
    switch (level) {
        case 1:
            ...
            return Py_BuildValue("{s:k,s:N,s:N,s:N}", "Flags", pi1->Flags, "pDescription",
                                 PyWinObject_FromTCHAR(pi1->pDescription), "pName", PyWinObject_FromTCHAR(pi1->pName),
                                 "pComment", PyWinObject_FromTCHAR(pi1->pComment));
        case 2:
            PRINTER_INFO_2 *pi2;
            pi2 = (PRINTER_INFO_2 *)printer_info;
            return Py_BuildValue(
                "{s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:N,s:k,s:k,s:k,s:k,s:k,s:k,s:k,s:k}", "pServerName",
                PyWinObject_FromTCHAR(pi2->pServerName), "pPrinterName", PyWinObject_FromTCHAR(pi2->pPrinterName),
                "pShareName", PyWinObject_FromTCHAR(pi2->pShareName), "pPortName",
                PyWinObject_FromTCHAR(pi2->pPortName), "pDriverName", PyWinObject_FromTCHAR(pi2->pDriverName),
                "pComment", PyWinObject_FromTCHAR(pi2->pComment), "pLocation", PyWinObject_FromTCHAR(pi2->pLocation),
                "pDevMode", PyWinObject_FromDEVMODE(pi2->pDevMode), "pSepFile", PyWinObject_FromTCHAR(pi2->pSepFile),
                "pPrintProcessor", PyWinObject_FromTCHAR(pi2->pPrintProcessor), "pDatatype",
                PyWinObject_FromTCHAR(pi2->pDatatype), "pParameters", PyWinObject_FromTCHAR(pi2->pParameters),
                "pSecurityDescriptor", PyWinObject_FromSECURITY_DESCRIPTOR(pi2->pSecurityDescriptor), "Attributes",
                pi2->Attributes, "Priority", pi2->Priority, "DefaultPriority", pi2->DefaultPriority, "StartTime",
                pi2->StartTime, "UntilTime", pi2->UntilTime, "Status", pi2->Status, "cJobs", pi2->cJobs, "AveragePPM",
                pi2->AveragePPM);
        case 3:
            PRINTER_INFO_3 *pi3;
            pi3 = (PRINTER_INFO_3 *)printer_info;
            return Py_BuildValue("{s:N}", "pSecurityDescriptor",
                                 PyWinObject_FromSECURITY_DESCRIPTOR(pi3->pSecurityDescriptor));
        case 4:
            PRINTER_INFO_4 *pi4;
            pi4 = (PRINTER_INFO_4 *)printer_info;
            return Py_BuildValue("{s:N,s:N,s:k}", "pPrinterName", PyWinObject_FromTCHAR(pi4->pPrinterName),
                                 "pServerName", PyWinObject_FromTCHAR(pi4->pServerName), "Attributes", pi4->Attributes);
        case 5:
            PRINTER_INFO_5 *pi5;
            pi5 = (PRINTER_INFO_5 *)printer_info;
            return Py_BuildValue("{s:N,s:N,s:k,s:k,s:k}", "pPrinterName", PyWinObject_FromTCHAR(pi5->pPrinterName),
        ...
        case 7:
            ...
            return Py_BuildValue("{s:N,s:k}", "ObjectGUID", PyWinObject_FromTCHAR(pi7->pszObjectGUID), "Action",
                                 pi7->dwAction);
...
static PyObject *PyGetPrinter(PyObject *self, PyObject *args)
{
    ...
    if (PyArg_ParseTuple(args, "O&:GetPrinter", PyWinObject_AsPrinterHANDLE,
                         &hprinter)) {  // @pyparm <o PyPrinterHANDLE>|hPrinter||handle to printer object as returned by
                                        // <om win32print.OpenPrinter>
        backward_compat = TRUE;
        level = 2;
    }
    else {
        PyErr_Clear();
        if (!PyArg_ParseTuple(args, "O&k:GetPrinter", PyWinObject_AsPrinterHANDLE, &hprinter,
    ...
    if (backward_compat) {
        ...
        rc = Py_BuildValue("NNNNNNNONNNNOkkkkkkkk", PyWinObject_FromTCHAR(pi2->pServerName),
                           PyWinObject_FromTCHAR(pi2->pPrinterName), PyWinObject_FromTCHAR(pi2->pShareName),
                           PyWinObject_FromTCHAR(pi2->pPortName), PyWinObject_FromTCHAR(pi2->pDriverName),
                           PyWinObject_FromTCHAR(pi2->pComment), PyWinObject_FromTCHAR(pi2->pLocation), Py_None,
                           PyWinObject_FromTCHAR(pi2->pSepFile), PyWinObject_FromTCHAR(pi2->pPrintProcessor),
                           PyWinObject_FromTCHAR(pi2->pDatatype), PyWinObject_FromTCHAR(pi2->pParameters), Py_None,
...
BOOL PyWinObject_AsPRINTER_INFO(DWORD level, PyObject *obinfo, LPBYTE *pbuf)
{
    ...
    *pbuf = NULL;
    ...
    switch (level) {
        case 2: {
            static char *pi2_keys[] = {"pServerName",
                                       "pPrinterName",
                                       "pShareName",
                                       "pPortName",
                                       "pDriverName",
            ...
            PyObject *obServerName = Py_None, *obPrinterName = Py_None, *obShareName = Py_None, *obPortName = Py_None,
            ...
            ret = PyArg_ParseTupleAndKeywords(dummy_tuple, obinfo, pi2_format, pi2_keys, &obServerName, &obPrinterName,
                                              ...
                                              &obSecurityDescriptor, &pi2->Attributes, &pi2->Priority,
                                              &pi2->DefaultPriority, &pi2->StartTime, &pi2->UntilTime, &pi2->Status,
                                              &pi2->cJobs, &pi2->AveragePPM) &&
        ...
        case 5: {
            static char *pi5_keys[] = {"pPrinterName",
                                       "pPortName",
                                       "Attributes",
...
static PyObject *PySetPrinter(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&kOk:SetPrinter", PyWinObject_AsPrinterHANDLE, &hprinter, &level, &obinfo, &command))
        return NULL;
...
static PyObject *PyEnumPrinters(PyObject *self, PyObject *args)
{
    ...
    static size_t printer_info_offset[] = {sizeof(PRINTER_INFO_1), sizeof(PRINTER_INFO_2), sizeof(PRINTER_INFO_3),
    ...
    if (!PyArg_ParseTuple(args, "k|Ok:EnumPrinters",
                          &flags,   // @pyparm int|flags||types of printer objects to enumerate (combination of
                                    // PRINTER_ENUM_* constants).
        ...
        if (ret != NULL)
            for (i = 0; i < printersreturned; i++) {
                if (level == 1) {
                    ...
                    obprinter_info =
                        Py_BuildValue("kNNN", info->Flags, PyWinObject_FromTCHAR(info->pDescription),
                                      PyWinObject_FromTCHAR(info->pName), PyWinObject_FromTCHAR(info->pComment));
                }
                else
...
// @pymethod int|win32print|StartDocPrinter|Notifies the print spooler that a document is to be spooled for printing. To
...
static PyObject *PyStartDocPrinter(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
            args, "O&k(OOO):StartDocPrinter", PyWinObject_AsPrinterHANDLE,
            &hprinter,  // @pyparm <o PyPrinterHANDLE>|hprinter||handle to printer (from <om win32print.OpenPrinter>)
    ...
    if (PyWinObject_AsTCHAR(obDocName, &pDocName, FALSE) && PyWinObject_AsTCHAR(obOutputFile, &pOutputFile, TRUE) &&
...
// @pymethod None|win32print|EndDocPrinter|The EndDocPrinter function ends a print job for the specified printer. To be
...
static PyObject *PyEndDocPrinter(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
            args, "O&:EndDocPrinter", PyWinObject_AsPrinterHANDLE,
            &hprinter))  // @pyparm <o PyPrinterHANDLE>|hPrinter||handle to printer (from <om win32print.OpenPrinter>)
        return NULL;
...
// @prop string/<o PyUnicode>|DataType|Type of data to be sent to printer, eg RAW, EMF, TEXT. Use None for printer
// default.
...
static PyObject *PyWritePrinter(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&O:WritePrinter", PyWinObject_AsPrinterHANDLE,
                          &hprinter,  // @pyparm <o PyPrinterHANDLE>|hprinter||Handle to printer as returned by <om
        ...
        return NULL;
    PyWinObject_GetBuffer pybuf(obbuf);
    if (!pybuf.ok())
        return NULL;
...
PyObject *JobtoPy(DWORD level, LPBYTE buf)
{
    ...
    switch (level) {
        case 1: {
            job1 = (JOB_INFO_1 *)buf;
            ret = Py_BuildValue(
                "{s:k, s:N, s:N, s:N, s:N, s:N, s:N, s:k, s:k, s:k, s:k, s:k, s:N}", "JobId", job1->JobId,
                "pPrinterName", PyWinObject_FromTCHAR(job1->pPrinterName), "pMachineName",
                PyWinObject_FromTCHAR(job1->pMachineName), "pUserName", PyWinObject_FromTCHAR(job1->pUserName),
                "pDocument", PyWinObject_FromTCHAR(job1->pDocument), "pDatatype",
                PyWinObject_FromTCHAR(job1->pDatatype), "pStatus", PyWinObject_FromTCHAR(job1->pStatus), "Status",
                job1->Status, "Priority", job1->Priority, "Position", job1->Position, "TotalPages", job1->TotalPages,
                "PagesPrinted", job1->PagesPrinted, "Submitted", PyWinObject_FromSYSTEMTIME(job1->Submitted));
            return ret;
        }
        case 2: {
            job2 = (JOB_INFO_2 *)buf;
            ret = Py_BuildValue(
                "{s:k, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:N, s:k, s:k, s:k, s:k, s:k, s:k, s:k, "
                "s:N, s:k, s:k}",
                "JobId", job2->JobId, "pPrinterName", PyWinObject_FromTCHAR(job2->pPrinterName), "pMachineName",
                PyWinObject_FromTCHAR(job2->pMachineName), "pUserName", PyWinObject_FromTCHAR(job2->pUserName),
                "pDocument", PyWinObject_FromTCHAR(job2->pDocument), "pNotifyName",
                PyWinObject_FromTCHAR(job2->pNotifyName), "pDatatype", PyWinObject_FromTCHAR(job2->pDatatype),
                "pPrintProcessor", PyWinObject_FromTCHAR(job2->pPrintProcessor), "pParameters",
                PyWinObject_FromTCHAR(job2->pParameters), "pDriverName", PyWinObject_FromTCHAR(job2->pDriverName),
                "pDevMode", PyWinObject_FromDEVMODE(job2->pDevMode), "pStatus", PyWinObject_FromTCHAR(job2->pStatus),
                "pSecurityDescriptor", PyWinObject_FromSECURITY_DESCRIPTOR(job2->pSecurityDescriptor), "Status",
                job2->Status, "Priority", job2->Priority, "Position", job2->Position, "StartTime", job2->StartTime,
                "UntilTime", job2->UntilTime, "TotalPages", job2->TotalPages, "Size", job2->Size, "Submitted",
                PyWinObject_FromSYSTEMTIME(job2->Submitted), "Time", job2->Time, "PagesPrinted", job2->PagesPrinted);
            return ret;
        }
        case 3: {
            job3 = (JOB_INFO_3 *)buf;
            ret = Py_BuildValue("{s:k, s:k, s:k}", "JobId", job3->JobId, "NextJobId", job3->NextJobId, "Reserved",
                                job3->Reserved);
            return ret;
        }
        default:
...
static PyObject *PyEnumJobs(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&kk|k:EnumJobs", PyWinObject_AsPrinterHANDLE,
                          &hprinter,  // @pyparm <o PyPrinterHANDLE>|hPrinter||Handle of printer.
                          ...
                          &level      // @pyparm int|Level|1|Level of information to return (JOB_INFO_1, JOB_INFO_2,
...
static PyObject *PyGetJob(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&k|k:GetJob", PyWinObject_AsPrinterHANDLE,
                          &hprinter,  // @pyparm <o PyPrinterHANDLE>|hPrinter||Handle to a printer as returned by <om
                                      // win32print.OpenPrinter>.
    ...
    *pbuf = NULL;
    switch (level) {
        ...
        case 3:
            ...
            ret = PyArg_ParseTupleAndKeywords(dummy_tuple, pyjobinfo, job3_format, job3_keys, &job3->JobId,
                                              &job3->NextJobId, &job3->Reserved);
            break;
        default:
            PyErr_Format(PyExc_NotImplementedError, "Information level %d is not supported", level);
    }
...
static PyObject *PySetJob(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(
            args, "O&kkOk:SetJob", PyWinObject_AsPrinterHANDLE,
            &hprinter,   // @pyparm <o PyPrinterHANDLE>|hPrinter||Handle of printer.
            &jobid,      // @pyparm int|JobID||Job Identifier.
            &level,      // @pyparm int|Level||Level of information in JobInfo dict (0, 1, 2, and 3 are supported).
            &pyjobinfo,  // @pyparm dict|JobInfo||JOB_INFO_* Dictionary as returned by <om win32print.GetJob> or <om
                         // win32print.EnumJobs> (can be None if Level is 0).
...
static PyObject *PyDocumentProperties(PyObject *self, PyObject *args)
{
    ...
    // @pyparm <o PyDEVMODE>|DevModeOutput||PyDEVMODE object that receives modified info, can be None if DM_OUT_BUFFER
    // not specified
    // @pyparm <o PyDEVMODE>|DevModeInput||PyDEVMODE that specifies initial configuration, can be None if DM_IN_BUFFER
    // not specified
    // @pyparm int|Mode||A combination of DM_IN_BUFFER, DM_OUT_BUFFER, and DM_IN_PROMPT - pass 0 to retrieve driver data
    // size
    if (!PyArg_ParseTuple(args, "OO&OOOk:DocumentProperties", &obhwnd, PyWinObject_AsPrinterHANDLE, &hprinter,
                          &obdevicename, &obdmoutput, &obdminput, &mode))
        return NULL;
    if (PyWinObject_AsTCHAR(obdevicename, &devicename, FALSE) && PyWinObject_AsHANDLE(obhwnd, (HANDLE *)&hwnd) &&
        PyWinObject_AsDEVMODE(obdmoutput, &dmoutput, TRUE) && PyWinObject_AsDEVMODE(obdminput, &dminput, TRUE)) {
...
// @pymethod (<o PyUnicode>,...)|win32print|EnumPrintProcessors|List printer processors for specified server and
// environment
static PyObject *PyEnumPrintProcessors(PyObject *self, PyObject *args)
{
    ...
    // @pyparm string/<o PyUnicode>|Environment|None|Environment - eg 'Windows NT x86' - use None for current client
    // environment
...
// @pymethod (<o PyUnicode>,...)|win32print|EnumPrintProcessorDatatypes|List data types that specified print provider
// recognizes
static PyObject *PyEnumPrintProcessorDatatypes(PyObject *self, PyObject *args)
{
    ...
    buf = (LPBYTE)malloc(bytes_needed);
    if (buf == NULL) {
        PyErr_Format(PyExc_MemoryError, "EnumPrintProcessorDatatypes: unable to allocate buffer of size %d",
                     bytes_needed);
        goto done;
    }
    bufsize = bytes_needed;
...
static PyObject *PyEnumPrinterDrivers(PyObject *self, PyObject *args)
{
    ...
    // @pyparm string/unicode|Environment|None|Environment - eg 'Windows NT x86' - use None for current client
    // environment
    ...
    case 1: {
        ...
        case 2:
            ...
            for (i = 0; i < return_cnt; i++) {
                tuple_item = Py_BuildValue("{s:l,s:u,s:u,s:u,s:u,s:u}", "Version", di2->cVersion, "Name", di2->pName,
                                           "Environment", di2->pEnvironment, "DriverPath", di2->pDriverPath, "DataFile",
                                           di2->pDataFile, "ConfigFile", di2->pConfigFile);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
        ...
        case 3:
            ...
            for (i = 0; i < return_cnt; i++) {
                tuple_item = Py_BuildValue("{s:l,s:u,s:u,s:u,s:u,s:u,s:u,s:N,s:u,s:u}", "Version", di3->cVersion,
                                           "Name", di3->pName, "Environment", di3->pEnvironment, "DriverPath",
                                           di3->pDriverPath, "DataFile", di3->pDataFile, "ConfigFile", di3->pConfigFile,
                                           "HelpFile", di3->pHelpFile, "DependentFiles",
                                           PyWinObject_FromMultipleString(di3->pDependentFiles), "MonitorName",
                                           di3->pMonitorName, "DefaultDataType", di3->pDefaultDataType);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
        ...
        case 4:
            ...
            for (i = 0; i < return_cnt; i++) {
                tuple_item = Py_BuildValue(
                    "{s:l,s:u,s:u,s:u,s:u,s:u,s:u,s:N,s:u,s:u,s:u}", "Version", di4->cVersion, "Name", di4->pName,
                    "Environment", di4->pEnvironment, "DriverPath", di4->pDriverPath, "DataFile", di4->pDataFile,
                    "ConfigFile", di4->pConfigFile, "HelpFile", di4->pHelpFile, "DependentFiles",
                    PyWinObject_FromMultipleString(di4->pDependentFiles), "MonitorName", di4->pMonitorName,
                    "DefaultDataType", di4->pDefaultDataType, "PreviousNames", di4->pszzPreviousNames);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
        ...
        case 5:
            ...
            for (i = 0; i < return_cnt; i++) {
                tuple_item = Py_BuildValue("{s:l,s:u,s:u,s:u,s:u,s:u,s:l,s:l,s:l}", "Version", di5->cVersion, "Name",
                                           di5->pName, "Environment", di5->pEnvironment, "DriverPath", di5->pDriverPath,
                                           "DataFile", di5->pDataFile, "ConfigFile", di5->pConfigFile,
                                           "DriverAttributes", di5->dwDriverAttributes, "DriverVersion",
                                           di5->dwDriverVersion, "ConfigVersion", di5->dwConfigVersion);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
        ...
        case 6:
            ...
            for (i = 0; i < return_cnt; i++) {
                tuple_item = Py_BuildValue(
                    "{s:l,s:u,s:u,s:u,s:u,s:u,s:u,s:N,s:u,s:u,s:u,s:N,s:L,s:u,s:u,s:u}", "Version", di6->cVersion,
                    "Name", di6->pName, "Environment", di6->pEnvironment, "DriverPath", di6->pDriverPath, "DataFile",
                    di6->pDataFile, "ConfigFile", di6->pConfigFile, "HelpFile", di6->pHelpFile, "DependentFiles",
                    PyWinObject_FromMultipleString(di6->pDependentFiles), "MonitorName", di6->pMonitorName,
                    "DefaultDataType", di6->pDefaultDataType, "PreviousNames", di6->pszzPreviousNames, "DriverDate",
                    PyWinObject_FromFILETIME(di6->ftDriverDate), "DriverVersion", di6->dwlDriverVersion, "MfgName",
                    di6->pszMfgName, "OEMUrl", di6->pszOEMUrl, "Provider", di6->pszProvider);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
...
PyObject *PyWin_Object_FromFORM_INFO_1(FORM_INFO_1W *fi1)
{
    ...
    return Py_BuildValue("{s:k,s:u,s:{s:l,s:l},s:{s:l,s:l,s:l,s:l}}", "Flags", fi1->Flags, "Name", fi1->pName, "Size",
                         "cx", fi1->Size.cx, "cy", fi1->Size.cy, "ImageableArea", "left", fi1->ImageableArea.left,
                         "top", fi1->ImageableArea.top, "right", fi1->ImageableArea.right, "bottom",
...
BOOL PyWinObject_AsRECTL(PyObject *obrectl, RECTL *rectl)
{
    ...
    if (PyArg_ParseTupleAndKeywords(dummy_tuple, obrectl, "llll", rectl_keys, &rectl->left, &rectl->top, &rectl->right,
                                    &rectl->bottom))
        return TRUE;
...
static PyObject *PyDeviceCapabilities(PyObject *self, PyObject *args)
{
    ...
    // @pyparm <o PyDEVMODE>|DEVMODE|None|If present, function returns values from it, otherwise the printer defaults
    // are used
...
static PyObject *PyEnumMonitors(PyObject *self, PyObject *args)
{
    ...
    switch (level) {
        ...
        case 2: {
            ...
            for (buf_ind = 0; buf_ind < return_cnt; buf_ind++) {
                tuple_item = Py_BuildValue("{s:u,s:u,s:u}", "Name", mi2->pName, "Environment", mi2->pEnvironment,
                                           "DLLName", mi2->pDLLName);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
...
static PyObject *PyEnumPorts(PyObject *self, PyObject *args)
{
    ...
    switch (level) {
        ...
        case 2: {
            ...
            for (buf_ind = 0; buf_ind < return_cnt; buf_ind++) {
                tuple_item = Py_BuildValue("{s:u,s:u,s:u,s:l,s:l}", "Name", pi2->pPortName, "MonitorName",
                                           pi2->pMonitorName, "Description", pi2->pDescription, "PortType",
                                           pi2->fPortType, "Reserved", pi2->Reserved);
                if (tuple_item == NULL) {
                    Py_DECREF(ret);
                    ret = NULL;
                    break;
...
// @pymethod <o PyUnicode>|win32print|GetPrintProcessorDirectory|Returns the directory where print processor files
// reside
static PyObject *PyGetPrintProcessorDirectory(PyObject *self, PyObject *args)
{
    // @pyparm str/<o PyUnicode>|Name||Name of server, use None for local machine
    // @pyparm str/<o PyUnicode>|Environment||Environment - eg 'Windows NT x86' - use None for current client
    // environment
    ...
    buf = (LPBYTE)malloc(bytes_needed);
    if (buf == NULL) {
        PyErr_Format(PyExc_MemoryError, "GetPrintProcessorDirectory: unable to allocate buffer of size %d",
                     bytes_needed);
        goto done;
    }
    bufsize = bytes_needed;
...
// @pymethod <o PyUnicode>|win32print|GetPrinterDriverDirectory|Returns the directory where printer drivers are
// installed
static PyObject *PyGetPrinterDriverDirectory(PyObject *self, PyObject *args)
{
    ...
    buf = (LPBYTE)malloc(bytes_needed);
    if (buf == NULL) {
        PyErr_Format(PyExc_MemoryError, "GetPrinterDriverDirectory: unable to allocate buffer of size %d",
                     bytes_needed);
        goto done;
    }
    bufsize = bytes_needed;
...
static PyObject *PyAddPrinter(PyObject *self, PyObject *args)
{
    ...
    if (PyWinObject_AsPRINTER_INFO(level, obinfo, &buf) && PyWinObject_AsTCHAR(observer_name, &server_name, TRUE)) {
...
{
    // @pyparm <o PyPrinterHANDLE>|hPrinter||Handle to printer as returned by <om win32print.OpenPrinter> or <om
...
static PyObject *PyDeletePrinterDriverEx(PyObject *self, PyObject *args)
{
    ...
    // environment
    // @pyparm string/<o PyUnicode>|DriverName||Name of driver to remove
    // @pyparm int|DeleteFlag||Combination of DPD_DELETE_SPECIFIC_VERSION, DPD_DELETE_UNUSED_FILES, and
...
static PyObject *PyFlushPrinter(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O&Ok", PyWinObject_AsPrinterHANDLE,
                          &hprinter,   // @pyparm <o PyPrinterHANDLE>|Printer||Handle to a printer
...
static struct PyMethodDef win32print_functions[] = {
    ...
    {"DeletePrinterConnection", PyDeletePrinterConnection,
     1},  // @pymeth DeletePrinterConnection|Disconnects from a network printer.
    {"EnumPrinters", PyEnumPrinters,
     1},  // @pymeth EnumPrinters|Enumerates printers, print servers, domains and print providers.
    {"GetDefaultPrinter", PyGetDefaultPrinter, METH_NOARGS},  // @pymeth GetDefaultPrinter|Returns the default printer.
    {"GetDefaultPrinterW", PyGetDefaultPrinterW,
     METH_NOARGS},                                    // @pymeth GetDefaultPrinterW|Returns the default printer.
    ...
    {"StartDocPrinter", PyStartDocPrinter, 1},  // @pymeth StartDocPrinter|Notifies the print spooler that a document is
                                                // to be spooled for printing. Returns the Jobid of the started job.
    {"EndDocPrinter", PyEndDocPrinter,
     1},  // @pymeth EndDocPrinter|The EndDocPrinter function ends a print job for the specified printer.
    {"AbortPrinter", PyAbortPrinter, 1},  // @pymeth AbortPrinter|Deletes spool file for printer
    {"StartPagePrinter", PyStartPagePrinter,
     1},  // @pymeth StartPagePrinter|Notifies the print spooler that a page is to be printed on specified printer
    ...
    {"WritePrinter", PyWritePrinter,
     1},  // @pymeth WritePrinter|Copies the specified bytes to the specified printer. StartDocPrinter and EndDocPrinter
          // should be called before and after. Returns number of bytes written to printer.
    ...
    {"EnumPrintProcessors", PyEnumPrintProcessors,
     1},  //@pymeth EnumPrintProcessors|List printer providers for specified server and environment
    {"EnumPrintProcessorDatatypes", PyEnumPrintProcessorDatatypes,
     1},  //@pymeth EnumPrintProcessorDatatypes|Lists data types that specified print provider supports
    ...
    {"DeviceCapabilities", PyDeviceCapabilities,
     1},  //@pymeth DeviceCapabilities|Queries a printer for its capabilities
    {"GetDeviceCaps", PyGetDeviceCaps,
     METH_VARARGS},                       //@pymeth GetDeviceCaps|Retrieves device-specific parameters and settings
    ...
    {"GetPrintProcessorDirectory", PyGetPrintProcessorDirectory,
     1},  //@pymeth GetPrintProcessorDirectory|Returns the directory where print processor files reside
    {"GetPrinterDriverDirectory", PyGetPrinterDriverDirectory,
     1},  //@pymeth GetPrinterDriverDirectory|Returns the directory where printer drivers are installed
    ...
    {"DeletePrinterDriver", PyDeletePrinterDriver,
     1},  //@pymeth DeletePrinterDriver|Deletes the specified driver from a server
    {"DeletePrinterDriverEx", PyDeletePrinterDriverEx,
     1},                                  //@pymeth DeletePrinterDriverEx|Deletes a printer driver and associated files
...
{
    PYWIN_MODULE_INIT_PREPARE(win32print, win32print_functions, "A module encapsulating the Windows printing API.")
